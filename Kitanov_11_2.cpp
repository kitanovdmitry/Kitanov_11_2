...
Задача №11, вариант 2
Цель: класс комплексных чисел в тригонометрической форме, действия над ними и производный класс с вычислением действительной, мнимой частей и комплексно сопряжённого
*/
#include <iostream>
#include <cmath>
#include <climits>
...
//Конструкторы и деструкторы:
    ...
    ComplexTrigonometry(double x) //Для сложения с действительным числом
    {
        setX(x);
        setY(0.0);
        setModule(x, y);
